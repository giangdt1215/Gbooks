			...
			<div class="row">
				<div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
					<div class="contact-form">
						<form:form action="/saveContact" method="post" role="form"
							modelAttribute="contact">
							<div class="form-group">
								<label for="contact-name"> Họ tên của bạn <span>*</span>
								</label>
								<form:input type="text" class="form-control" name="contact-name"
							...
							<div class="form-group">
								...
								<form:textarea rows="4" class="form-control"
									...
									placeholder="Nhập nội dung" required="required" path="message"></form:textarea>
							</div>
							<button type="submit" class="submit">Gửi liên hệ</button>
						</form:form>
					</div>
				</div>
