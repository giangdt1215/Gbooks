				...
				<div class="row">
					<div class="col-lg-12">
						<form:form action="${pageContext.request.contextPath }/admin/save-book" method="post"
							...
							<%-- <c:forEach items="${product.productsAuthors }" varStatus="vs">
								<div class="form-group">
									<label for="productAuthor">Nhập tên tác giả ${vs.index + 1}<span class="required-input">*</span></label>
									<form:hidden path="productsAuthors[${vs.index }].author.id"/>
									<form:input type="text" class="form-control"
										name="productAuthor" id="productAuthor"
										placeholder="Nhập tên tác giả"
										path="productsAuthors[${vs.index }].author.name" required="required" />
								</div>
							</c:forEach> --%>
							...
							<div class="form-group">
								<label for="productAvatar">Ảnh bìa sản phẩm </label>
							...
							<button type="submit" class="btn btn-primary" id="editBtn">Lưu thay đổi</button>
