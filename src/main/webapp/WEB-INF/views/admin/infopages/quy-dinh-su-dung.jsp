...
<title>Chỉnh sửa quy định sử dụng</title>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Chỉnh sửa quy định sử dụng</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
				...
				<div class="row">
					<div class="col-lg-12">
						<form:form action="${pageContext.request.contextPath }/admin/save-quy-dinh-su-dung" method="post"
							modelAttribute="shopInfo">
							<form:hidden path="id"/>
							<div class="form-group">
								<label for="qdSuDung">Nhập nội dung quy định sử dụng <span class="required-input">*</span></label>
								<form:textarea rows="10" class="form-control" name="qdSuDung"
									id="qdSuDung" placeholder="Nhập nội dung quy định sử dụng" required="required"
									path="qdSuDung"></form:textarea>
							</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#qdSuDung').summernote({
				placeholder: 'Hãy nhập nội dung quy định sử dụng',
				height: 600
			});
		});
	</script>
