	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Chỉnh sửa trang giới thiệu</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
				...
				<div class="row">
					<div class="col-lg-12">
						<form:form action="${pageContext.request.contextPath }/admin/save-gioi-thieu" method="post"
							modelAttribute="shopInfo">
							<form:hidden path="id"/>
							<div class="form-group">
								<label for="gioiThieu">Nhập nội dung trang giới thiệu <span class="required-input">*</span></label>
								<form:textarea rows="10" class="form-control" name="gioiThieu"
									id="gioiThieu" placeholder="Nhập nội dung trang giới thiệu" required="required"
									path="gioiThieu"></form:textarea>
							</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#gioiThieu').summernote({
				placeholder: 'Hãy nhập nội dung trang giới thiệu',
				height: 600
			});
		});
	</script>
